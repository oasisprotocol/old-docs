...
2. Make sure you are in a secure location, and then `Click to reveal`.
   This will reveal your _private key_, which is used to access your wallet.
...
You can now tell your spiffy frontend to talk to the service running at the address you get from running deploy.
